...
This replaces the previous fastapi-users setup with first-party FastAPI
helpers.
"""
...
# ---------------------------------------------------------------------------
# OAuth state helpers (in-memory; replace with Redis in production)
# ---------------------------------------------------------------------------

def create_oauth_state(provider: str, return_url: Optional[str] = None) -> str:
    import secrets
...
def require_roles(*allowed_roles: UserRole):
    """Dependency factory ensuring the current user has allowed roles."""

    async def _checker(
        user: Annotated[DomainUser, Depends(get_current_active_user)]
    ):
