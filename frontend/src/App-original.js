...
const RentalsListPage = lazy(() => import("./Pages/Rentals/RentalsList"));
const RentalDetailPage = lazy(() => import("./Pages/Rentals/RentalDetail"));
            ...
            <AnimatePresence mode="wait">
              <Suspense fallback={<></>}>
                <Routes>
                  ...
                  <Route path="/" element={<TravelAgencyPage style={{ "--base-color": "#ff7a56" }} />} />
